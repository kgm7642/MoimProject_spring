...
<body class="is-preload">
	...
	<c:if test="${param.outCheck == true}">
		<script>
			alert("모임 탈퇴 완료!");
		</script>
	</c:if>
	<c:if test="${param.outCheck == false}">
		<script>
			alert("모임 탈퇴 실패. 다시 시도해 주세요.");
		</script>
	</c:if>
			...
			<section id="main" class="main">
				<div class="inner">
					...
					<div style="margin: 10px;">
						<span style="font-size: 2em;"><strong>&lt 참여중인 모든
								모임 &gt</strong></span> <span style="float: right;"> 오늘 시작 : <span
							style="color: #7fa4e5; font-size: 2em;">■ </span> 진행중 : <span
							style="color: #c6e0eb; font-size: 2em;">■ </span> 진행 예정 : <span
							style="color: #fdf8b4; font-size: 2em;">■ </span> 종료 : <span
							style="color: #c4c9d3; font-size: 2em;">■ </span>
						</span>
					</div>
					...
					<a href="/moim/createPlace" class="button primary fit"
						...
						href="/moim/myMoimKing?userid=${session.userid}"
						class="button fit"
						style="width: 30%; display: inline-block; float: right;">방장인
						모임 보기</a>
					<hr>
				</div>
			</section>
...
<script src="/resources/assets/js/moim/myMoimAll.js"></script>
</html>